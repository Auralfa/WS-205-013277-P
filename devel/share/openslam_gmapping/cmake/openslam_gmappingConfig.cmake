...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/openslam_gmapping-0.2.1)
  set(openslam_gmapping_DEVEL_PREFIX /home/zw/scout_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/zw/scout_ws/install)
...
if(NOT "/home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/openslam_gmapping-0.2.1/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/openslam_gmapping-0.2.1/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/openslam_gmapping-0.2.1/${idir}'.  ${_report}")
    endif()
