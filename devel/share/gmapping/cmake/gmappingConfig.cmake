...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/slam_gmapping-1.4.1/gmapping)
  set(gmapping_DEVEL_PREFIX /home/zw/scout_ws/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /home/zw/scout_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zw/scout_ws/src/Scout_mini_ROS1_Navigation/packages/slam-gmapping/slam_gmapping-1.4.1/gmapping/${idir}'.  ${_report}")
    endif()
